...
def pick_random_word():
    ...
    # -1 because length of words is not a valid index in the list 'words'
...
if(__name__ == '__main__'):
    ...
    #loop that repeats the guessing sequence until user guesses all letters OR they run out of guessed
